...
// This module test should only test the ros functionality of any node (does it run, does it respond correctly to
// messages).
...
// TEST(path_publisher_ros_tool, PathPublisherTest){
//    //your tests go here
//}

int main(int argc, char** argv) {
    testing::InitGoogleTest(&argc, argv);
    ros::init(argc, argv, "path_publisher_test");
